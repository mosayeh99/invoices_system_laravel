    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-xl-auto right-content">
            @can('Export Invoices Excel')
                @if(Route::is('reports.invoices.index'))
                    <div class="pr-1 mb-3 mb-xl-0">
                        <a href="{{route('invoices.export', 'all')}}" class="btn btn-success-gradient">Export Excel</a>
                    </div>
                @else
                    <div class="pr-1 mb-3 mb-xl-0">
                        <form action="{{route('reports.invoices.export')}}" method="post">
                            @csrf
                ...
                <form action="{{route('reports.invoices.search')}}" method="post">
                    ...
                    <div class="row row-sm px-4 pt-4">
                        <div class="col-lg">
                            ...
                            <select id="payment_status_search_value" name="payment_status" class="form-control select2-no-search">
...
@section('js')
    ...
    <script>
        document.querySelector('#payment_status_search_value').value = "{{$payment_status ?? ''}}"
