            ...
            <div class="card">
                <div class="card-header pb-0 d-flex justify-content-end">
                    @can('Export Invoices Excel')
                        <div>
                            <a href="{{route('invoices.export', 'archives')}}" class="btn btn-success-gradient">Export Excel</a>
                        </div>
                    @endcan
                </div>
                <div class="card-body">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div  class="dropdown-menu tx-13">
                                                ...
                                                @can('Archive Invoices')
                                                    <a class="dropdown-item" href="{{route('invoices.restore', $invoice->id)}}">Restore</a>
                                                @endcan
                                                @can('Delete Invoices')
